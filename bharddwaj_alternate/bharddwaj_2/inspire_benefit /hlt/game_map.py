...
class GameMap:
    ...
    def getGoalCell(self, position, reserved):
        goalCells = list(filter(lambda cell: cell not in reserved, self.wealthyCells))
    ...
    def _scanMap(self):
        ...
        for y in range(self.height):
            ...
            for x in range(self.width):
                ...
                halite_amount = self[currentPosition].halite_amount
                halite_amounts.append(halite_amount)
                totalHaliteInMap += halite_amount
                medianOfRow.append(halite_amount)

...
while True:
    ...
    if game.turn_number < constants.MAX_TURNS / 2.3 and me.halite_amount >= constants.SHIP_COST and not game_map[me.shipyard].is_occupied and not game_map[me.shipyard].booked:

    ...
    for ship in me.get_ships():
        ...
        for i in range(0,6):
            for j in range(0,6):
                ...
                iterations_for_below2 = 0
                if not i == 0 and j == 0:
                    for i in halite_amount_based_dict:
                        iterations_for_below2 += 1
                        temp_list = []
                    ...
                    for i in halite_amount_based_dict:
                        some_list = []
                        if ship.position == halite_amount_based_dict[i][0]:
                            some_list.append((ship.position,halite_amount_based_dict[i][1]))
                            if len(halite_amount_based_dict[i]) > 2:
                                the_list =halite_amount_based_dict[i]
                                some_list.append(the_list[2])
                        if not some_list == []:
        ...
        logging.info(f"iterations_for_below: {iterations_for_below2} ")

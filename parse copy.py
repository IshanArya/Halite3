...
#   player = [p for p in data['players'] if p['name'].split(" ")[0] == player_name][0] #this is the original code
    player = [p for p in data['players'] if p['name'].split(" ")[0] in player_name][0]
